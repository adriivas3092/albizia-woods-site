    ...
    <section className={styles.materials}>
      <div className={`container ${styles.grid}`}>
        <div className={styles.imageCol}>
          <img src="/material_metal.png" alt="Brushed metal texture" className={styles.image} loading="lazy" />
          <img src="/material_piedra.png" alt="Travertine stone texture" className={`${styles.image} ${styles.offsetImage}`} loading="lazy" />
        </div>
