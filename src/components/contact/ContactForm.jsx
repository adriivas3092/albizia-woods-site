...
const COPY = {
  ...
  es: {
    heading: 'Conversemos sobre tu visión.',
    intro: 'Ya sea que seás un arquitecto en busca de elementos a medida para un proyecto de hotelería, o un cliente particular que busca esa pieza central perfecta, nuestro estudio está listo para colaborar con vos.',
    ...
    type: 'Tipo de Proyecto *', typePlaceholder: 'Seleccioná el tipo de proyecto',
    options: {
    ...
    message: 'Mensaje *', messagePlaceholder: 'Contanos sobre tu proyecto, materiales o plazos...',
    submit: 'Enviar Consulta',
    loading: 'Enviando su consulta de forma segura...',
    successTitle: 'Gracias.',
    successText: 'Tu consulta fue recibida por nuestro estudio. Revisaremos los detalles de tu proyecto y te contactaremos en breve.',
    submitAnother: 'Enviar Otra',
    errorTitle: 'Error de Conexión',
    errorText: 'No pudimos procesar tu solicitud en este momento. Intentá de nuevo o contactanos directamente por WhatsApp.',
