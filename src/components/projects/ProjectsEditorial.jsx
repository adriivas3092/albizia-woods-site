    ...
    <section className={styles.editorial}>
      <div className={`container ${styles.grid}`}>
        ...
        <div className={styles.imageCol}>
          <img src="/Proyectos/Lat90_BAJA088.jpg" alt="Papagayo Residence interior" className={styles.mainImage} loading="lazy" />
        </div>
      </div>
      
      <div className={styles.fullWidthImage}>
        <img src="/Proyectos/Lat90_BAJA079.jpg" alt="Dining area details" loading="lazy" />
      </div>
    </section>
  );
}
