    ...
    <section className={styles.context}>
      <div className={`container ${styles.grid}`}>
        <div className={styles.imageColPrimary}>
          <img src="/Proyectos/Lat90_BAJA093.jpg" alt="Living space with Albizia Woods furniture" loading="lazy" />
        </div>
        ...
        <div className={styles.contentCol}>
          ...
          <div className={styles.imageColSecondary}>
            <img src="/Proyectos/Lat90_BAJA108.jpg" alt="Architectural integration" loading="lazy" />
          </div>
        </div>
      </div>
    </section>
